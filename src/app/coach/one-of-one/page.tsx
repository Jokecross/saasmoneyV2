...
import { OneOfOneSlot } from "@/lib/supabase/types";
...
export default function CoachOneOfOnePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 animate-slide-up">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">One of One Calls</h1>
          <p className="text-gray-500">
            Gère tes disponibilités pour les calls 1:1 avec les élèves.
          </p>
        </div>
        <Button
          variant="gradient"
                ...
                <div className="space-y-2 min-h-[200px]">
                    ...
                    <div
                      ...
                      className={cn(
                        ...
                        slot.is_available
                          ...
                          : "bg-magenta-100 text-magenta hover:bg-magenta-200"
                      )}
                    >
                      ...
                      {!slot.is_available && (
                        <Badge size="sm" variant="magenta" className="mt-1 text-[9px]">
                          Réservé
                        </Badge>
                      )}
                    </div>
                  ...
                  {!past && (
                    <button
                      ...
                      className="w-full p-2 rounded-xl border-2 border-dashed border-gray-200 text-gray-400 hover:border-magenta hover:text-magenta transition-colors text-xs flex items-center justify-center gap-1"
                    >
      ...
      <div className="flex items-center gap-6 text-sm text-gray-500">
        ...
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded bg-magenta-100" />
          <span>Réservé</span>
        </div>
      </div>
        ...
        {selectedSlot && (
          <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {formatTime(selectedSlot.date)} - {selectedSlot.duration} minutes
                  </p>
                </div>
              </div>
            </Card>
            ...
            <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-xl">
              <Badge
                variant={selectedSlot.is_available ? "default" : "magenta"}
